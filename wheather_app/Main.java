...
import java.net.HttpURLConnection;  // для работы с сетью
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Устанавливаем настройки прокси-сервера для сетевого соединения
        System.setProperty("https.proxyHost", PROXY_HOST);
        System.setProperty("https.proxyPort", String.valueOf(PROXY_PORT));

        //Список городов для которых получим данные о погоде
